...
var box_x = 0, box_x_go2=0, bg_race= 0, box_number = 0, finish_race = 0, box_x_go=0;
...
$(".startrace").click( async () => {
    ...
    while (finish_race-100 <= finish){
        ...
        box_x1 = Math.floor(Math.random() * 7 );
        box_x2 = Math.floor(Math.random() * 3);
        box_x3 = -Math.floor(Math.random() * 3);
        ...
        //     left: box_x_go2,
        // })
        // box_number4 = Math.floor(Math.random() * 29) / 4;
        // for (let i = 1; i < box_number4; i++) {
        //     listbox2=[
        //         box_x1 += Math.floor(Math.random() * 10) - Math.floor(Math.random() * 8),
        //         box_x2 += Math.floor(Math.random() * 10) - Math.floor(Math.random() * 8),
        //         box_x3 += Math.floor(Math.random() * 10) - Math.floor(Math.random() * 8),
        //         box_x4 += Math.floor(Math.random() * 10) - Math.floor(Math.random() * 8),
        //         box_x5 += Math.floor(Math.random() * 10) - Math.floor(Math.random() * 8),
        //         box_x6 += Math.floor(Math.random() * 10) - Math.floor(Math.random() * 8),
        //     ]
        //     console.log(i);
        //     $(".box"+i).css({
        //         left: listbox2[i-1]
